...
interface ChatMessagesProps {
  ...
  recipientDetails: UserDetails; // Added recipient details prop
...
const ChatMessages: React.FC<ChatMessagesProps> = ({ 
  ...
  userDetails, 
  selectedUserId,
  recipientDetails, // Added recipient details
  setMessages,
  ws,
  children
}) => {
 ...
 // Replace your current messagesToRender generation with this:
// Update your messagesToRender generation to this:
